...
<div class="bg-white border border-gray-600 shadow-md mr-3">
    <p class="text-sm text-center bg-gray-600 text-white py-1 pl-2">検索条件</p>
    <form method="GET" action="{{ route($searchRoute) }}" class="m-0">
        <div class="flex flex-col px-3">
            <x-search.input id="search_order_no" label="受注番号" />
            <x-search.input id="search_order_control_id" label="受注管理ID" />
            <!-- 検索ボタン -->
